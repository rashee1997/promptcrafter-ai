...
- **Product Shoot Studio Upgrade: Directorial Controls, Multi-Dialect Deck & Local Persistence** — full commercial director prompt engineering workbench for product video generations:
  - **Directorial Art Direction & Customizable Controls** (`components/product-shoot/creative-controls.tsx`): interactive chip rows for Camera Choreography (Orbit 360°, Macro Dolly-In, Hero Crane, Flatlay, FPV, Whip-Pan, Static), Lighting Design (Chiaroscuro, Softbox, Golden Hour, Cyberpunk Neon, Backlit Rim, Editorial), Surface/Pedestal Materials (Carrara Marble, Wet Obsidian, Concrete, Sand, Titanium, Water Basin, Zero-G), Physics & FX (1000fps Splash Crown, Condensation Mist, Powder Burst, Aromatic Steam, Prisms, Botanicals), Motion Pace (120fps Slow-Mo, 24fps Cinematic, Fast Cut, Hyperlapse), and Human/UGC Interaction (Pure Product, Hands Unboxing, Routine Application, Swatching, UGC Creator).
