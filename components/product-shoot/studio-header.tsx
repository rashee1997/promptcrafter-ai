  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-border/60">
      ...
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand/20 via-accent/15 to-brand/5 border border-brand/30 flex items-center justify-center shadow-[0_4px_16px_var(--shadow-sm)]">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-brand/10 text-brand border border-brand/25">
              <Sparkles className="w-3 h-3" />
              I2V Director
            </span>
          </div>
          <p className="text-xs text-text-secondary">
            Lock your physical product reference & create multi-dialect commercial shot packages.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-border bg-surface-card hover:bg-surface-muted/60 text-xs font-medium text-text-primary transition-colors"
          ...
          {showModelMenu && (
            <div className="absolute right-0 mt-1.5 w-60 rounded-xl border border-border bg-surface-elevated shadow-[0_12px_32px_var(--shadow-lg)] p-1.5 z-40 backdrop-blur-xl animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="relative">
          ...
          {showExamplesMenu && (
            <div className="absolute right-0 mt-1.5 w-72 rounded-xl border border-border bg-surface-elevated shadow-[0_12px_32px_var(--shadow-lg)] p-1.5 z-40 backdrop-blur-xl animate-in fade-in zoom-in-95 duration-150">
        ...
        <button
          type="button"
          onClick={onReset}
          className="p-1.5 rounded-lg border border-border bg-surface-card hover:bg-surface-muted/60 text-text-muted hover:text-danger transition-colors"
