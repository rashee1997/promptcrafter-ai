    ...
    <div className="space-y-2.5">
      ...
      <div className="flex items-center justify-end gap-2 pt-1">
        ...
        <button
          ...
          disabled={!canSave}
          className="px-3 py-1.5 rounded-lg text-xs font-semibold text-white bg-gradient-to-br from-brand to-accent shadow-glow hover:brightness-110 active:scale-[0.985] transition-all disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Save character
        </button>
      </div>
